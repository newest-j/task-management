        ...
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            <div class="chart-pie pt-4 pb-2">
              ...
              <div
                class="chart-placeholder d-flex justify-content-center align-items-center"
              >
            ...
            <div class="mt-4 text-center small">
              <span class="me-2">
                <i class="bi bi-circle-fill text-primary"></i> Development
              </span>
              <span class="me-2">
                <i class="bi bi-circle-fill text-success"></i> Marketing
              </span>
              <span class="me-2">
                <i class="bi bi-circle-fill text-info"></i> Design
              </span>
              <span>
                <i class="bi bi-circle-fill text-warning"></i> Research
              </span>
            </div>
          </div>
        </div>
        ...
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            <div class="chart-area">
              <!-- Placeholder for line chart - in a real app, you'd use Chart.js or similar -->
              <div class="chart-placeholder">
                <div class="line-chart">
                  <div class="line-point" style="height: 30%; left: 0%"></div>
                  <div
                    class="line-point"
                    style="height: 60%; left: 16.6%"
                  ></div>
                  <div
                    class="line-point"
                    style="height: 40%; left: 33.2%"
                  ></div>
                  <div
                    class="line-point"
                    style="height: 80%; left: 49.8%"
                  ></div>
                  <div
                    class="line-point"
                    style="height: 50%; left: 66.4%"
                  ></div>
                  <div class="line-point" style="height: 70%; left: 83%"></div>
                  <div
                    class="line-point"
                    style="height: 90%; left: 99.6%"
                  ></div>
                </div>
              </div>
            </div>
          ...
          <div class="card-body">
            <div class="timeline">
              <div class="timeline-item">
                ...
                <div class="timeline-content">
                  ...
                  <p class="mb-0 text-muted">
                    Database Migration completed by Mike Johnson
                  </p>
              ...
              <div class="timeline-item">
                ...
                <div class="timeline-content">
                  <h6 class="mb-0">New Task Created</h6>
                  <p class="mb-0 text-muted">
                    API Documentation assigned to Sarah Williams
                  </p>
              ...
              <div class="timeline-item">
                ...
                <div class="timeline-content">
                  <h6 class="mb-0">Task Status Updated</h6>
                  <p class="mb-0 text-muted">
                    Mobile App Testing changed to In Progress
                  </p>
              ...
              <div class="timeline-item">
                ...
                <div class="timeline-content">
                  <h6 class="mb-0">Task Deadline Updated</h6>
                  <p class="mb-0 text-muted">
                    Design Homepage Layout deadline extended
                  </p>
                  <small class="text-muted">Jan 10, 2024, 9:20 AM</small>
                </div>
              </div>
            </div>
          </div>
...
.segment-4 {
  ...
  clip-path: polygon(50% 50%, 25% 100%, 100% 100%);
}
